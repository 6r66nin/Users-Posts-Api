...
const idparamHandler_1 = __importDefault(require("../Middleware/idparamHandler"));
const Controller = __importStar(require("../Controllers/postsController"));
const postsRouter = (0, express_1.Router)();
postsRouter.route("/").get(Controller.getPosts).post(Controller.addPost);
postsRouter.use("/:id", idparamHandler_1.default);
postsRouter
    .route("/:id")
